...
public abstract class ICancellationMethod : IDisposable
{
    ...
    public void Cancel()
    {
        Console.WriteLine("ICancellationMethod.Cancel: Cancelled");
    ...
    public virtual void NextCycle()
    {
        if (_cancelNextCycle)
        {
            Console.WriteLine("ICancellationMethod.NextCycle: Cancelled");
            _tokenSource.Cancel();
